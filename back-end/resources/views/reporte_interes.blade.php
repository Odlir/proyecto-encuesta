...
<body>
    <div class="text-center font-weight-bold">
        ...
        <div class="mt">
            ...
            <div class="mt-persona text-secondary">
                ...
                <p class="h1 mt-text">{{$persona->apellido_paterno}} {{$persona->apellido_materno}},
                    {{$persona->nombres}}</p>
    ...
    <div class="page_break text-justify">
        ...
        <div>
            <p>
                Una de las decisiones más importantes en la vida de una persona, es la relacionada a la elección de la
                carrera a seguir, pues su sentido de producción y felicidad futuras,
            ...
            <p>
                ...
                El gusto que tendrías por realizar alguna actividad en tu vida profesional, b. Las habilidades que
                tienes para aprender a
                realizar esta actividad, y c. La satisfacción que crees que te brindaría realizar esta actividad como
                parte de tu profesión.
            </p>
            <p>
                Este instrumento ha sido elaborado y estandarizado por la prestigiosa firma de
                Effectus Fischman Consultores, contando con los criterios de validez y confiabilidad que el programa
                demanda.
            </p>
        </div>
        <div>
